...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.addTab(actionBar.newTab().setText("Chamadas").setTabListener(new MyTabListener(this,1)));
        actionBar.addTab(actionBar.newTab().setText("Conversas").setTabListener(new MyTabListener(this,2)));
        actionBar.addTab(actionBar.newTab().setText("Contatos").setTabListener(new MyTabListener(this,3)));
